...
urlpatterns = [
    ...
    path('n/lobby', views.lobby, name='lobby'),
    path('n/room/', views.room, name='room'),
    path('n/get_token/', views.getToken, name='get_token'),
    path('n/create_member/', views.createMember, name='create_member'),
    path('n/get_member/', views.getMember, name='get_member'),
    path('n/delete_member/', views.deleteMember, name='delete_member')
]
